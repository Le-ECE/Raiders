 ...
 *          <p>
 *          <b>choose</b> Instance of JFileChooser used to select directory to
 *          save in
 *          <p>
 *          <b>newView</b> Instance of FileSystemView used to view the file
 *          directory
 *          <p>
...
public class SaveManager {
	...
	/**
	 * SaveManager constructor is responsible for initializing loadedSave to a
	 * new Save, with default parameters.
	 */
	public SaveManager() {
	 ...
	 * 
	 * @param newSave
	 *            Save representing new Save data
	 */
	 ...
	 * labeled save file. The save file is labeled with the date, as well as the
	 * user's name. The save file contains the name, game stage, as well as the
	 * current user time. The first if statement is used to determine if the
	 * save directory exists. If it does not, a new save directory is created.
	 * The first try-catch is used to catch various IO exceptions. 
	 */

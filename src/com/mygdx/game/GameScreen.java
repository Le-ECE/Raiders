...
//		}
	...
	private void boulderDraw(String direction, int distance, String rotation){
		if(direction.equals("up"))
			batch.draw(boulder1, x, y, originX, originY, width, height, scaleX, scaleY, rotation);
	}
	...
	private void createMap(){
		...
		boulderXArr=new ArrayList<Integer>();
		boulderYArr=new ArrayList<Integer>();
